...
const EditSubCategoryForm = ({ subCategory, onClose, onSuccess }) => {
  ...
  useEffect(() => {
    if (subCategory) {
      setFormData({
        ...
        isActive: subCategory.isActive ? "yes" : "no",
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await updateSubCategory(subCategory.subCategoryId, payload);
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-black/50 z-50">
      <div className="bg-white rounded-2xl shadow-lg w-full max-w-lg p-6 relative">
        ...
        <h2 className="text-2xl font-bold text-green-700 mb-4">✏️ Edit Subcategory</h2>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <div
              ...
              onClick={() => document.getElementById("editSubFileInput").click()}
            >
              {uploadingImage ? (
