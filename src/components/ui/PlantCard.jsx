...
const PlantCard = () => {
  ...
  const plants = [
    ...
    },
    {
      ...
      image:
        "https://media.gardenista.com/wp-content/uploads/2019/01/fiddle-leaf-fig-tree-ikea-733x741.png",
      rating: 4,
      discount: "10%",
      price: 450,
      originalPrice: 500,
    },
    {
      name: "Aloe Vera",
      image:
        "https://plantorbit.com/cdn/shop/files/white-Photoroom-2025-08-10T103921.024.jpg?v=1754809193&width=600",
      rating: 5,
      discount: "20%",
      price: 200,
      originalPrice: 250,
    },
    {
      name: "Monstera",
      image:
        "https://www.homesake.in/cdn/shop/files/IH0F022-GR-1_Theme_951fcfb0-eb53-4f2d-960b-3d8a5a1b920d.jpg?v=1754994053&width=600",
      rating: 4,
      discount: "12%",
      price: 600,
      originalPrice: 680,
    },
    {
      name: "Peace Lily",
      image:
        "https://americanplantexchange.com/cdn/shop/products/peacelily-1.jpg?v=1672881763&width=823",
      rating: 5,
      discount: "18%",
      price: 350,
      originalPrice: 430,
    },
    {
      name: "ZZ Plant",
      image:
        "https://www.ugaoo.com/cdn/shop/products/Growpot.jpg?v=1755584321&width=750",
      rating: 4,
      discount: "10%",
      price: 400,
      originalPrice: 450,
  ...
  return (
    <div className="mt-10 mb-10">
      ...
      <div className="text-center mb-10">
        <h2 className="text-4xl font-bold text-black-700">🌼 Best Sellers 🌼</h2>
      </div>
      ...
      >
        {[...plants, ...plants].map((plant, index) => (
          <div
            key={index}
            className="relative bg-white rounded-xl shadow-md overflow-hidden flex-shrink-0 w-64 sm:w-72 md:w-72 lg:w-78"
          >
            {/* Discount Tag */}
